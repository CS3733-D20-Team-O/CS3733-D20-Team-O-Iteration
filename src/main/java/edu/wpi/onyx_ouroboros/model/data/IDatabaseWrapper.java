...
public interface IDatabaseWrapper extends AutoCloseable {
   ...
   * <p>
   * Broadcasts DatabaseInsertionEvent upon successful addition
   *
   ...
   * <p>
   * Broadcasts DatabaseRemovalEvent upon successful removal
   *
   ...
   * <p>
   * Broadcasts DatabaseUpdateEvent upon successful update
   *
